...
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("/home/james/.local/bin/smart_clipboard.sh"))
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("/home/james/.local/bin/smart_controlcenter.sh"))
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("/home/james/.local/bin/smart_theme.sh"))
...
hl.bind(mainMod .. " + B", function()
    ...
    hl.exec_cmd("/home/james/.local/bin/battery_mode.sh")
end)
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("/home/james/.local/bin/smart_volume.sh up"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("/home/james/.local/bin/smart_volume.sh down"), { locked = true, repeating = true })
hl.bind("XF86AudioMute",        hl.dsp.exec_cmd("/home/james/.local/bin/smart_volume.sh mute"), { locked = true })
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("/home/james/.local/bin/smart_brightness.sh up"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("/home/james/.local/bin/smart_brightness.sh down"), { locked = true, repeating = true })
...
hl.bind(mainMod .. " + XF86AudioMicMute", hl.dsp.exec_cmd("/home/james/.local/bin/spotify_restart.sh"),   { locked = true })
