...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd(p.smartVolume .. " up"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd(p.smartVolume .. " down"), { locked = true, repeating = true })
hl.bind("XF86AudioMute",        hl.dsp.exec_cmd(p.smartVolume .. " mute"), { locked = true })
hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd(p.smartBrightness .. " up"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd(p.smartBrightness .. " down"), { locked = true, repeating = true })
...
hl.bind(mainMod .. " + XF86AudioMicMute", hl.dsp.exec_cmd(p.spotifyRestart),   { locked = true })
